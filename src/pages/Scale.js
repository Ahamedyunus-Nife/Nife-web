...
import SparkleAnimation from './UnlockWithOikos';
...
const IndiaMap = () => {
    return (
        <Container>
            <h2 className="title mx-auto mt-4 text-align-center gradient-text fw-bold">
                Local to Global in mintues.
            </h2>
                ...
                <Grid item xs={12} sm={4}>
                    <Card sx={{ mt: 2 }}>
                        <div style={{ paddingLeft: "10px", paddingTop: "10px" }}>
                            ...
                            <svg stroke="currentColor" fill="none" stroke-width="1" viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round" height="50px" width="50px" xmlns="http://www.w3.org/2000/svg"><path d="M20.942 13.02a9 9 0 1 0 -9.47 7.964"></path><path d="M3.6 9h16.8"></path><path d="M3.6 15h9.9"></path><path d="M11.5 3a17 17 0 0 0 0 18"></path><path d="M12.5 3c2 3.206 2.837 6.913 2.508 10.537"></path><path d="M20 21l2 -2l-2 -2"></path><path d="M17 17l-2 2l2 2"></path></svg>
                        </div>
                        ...
                        >
                            ...
                            >
                                <div style={{ paddingLeft: "20px", paddingTop: "20px" }}>
                                    <img alt='Nife Scaling supports AWS' src={awslogo} style={{ height: "30px", width: "auto", objectFit: "contain", marginRight: "10px", aspectRatio: "1/1" }} />
                                    <img alt='Nife Scaling supports GCP' src={"https://brandeps.com/logo-download/G/Google-Cloud-logo-vector-01.svg"} style={{ height: "30px", width: "30px", objectFit: "cover", aspectRatio: "1/1" }} />
                                </div>
                                <div style={{ paddingLeft: "20px", paddingTop: "10px" }}>
                                    <img alt='Nife Scaling supports Mirosoft Azure' src={"https://upload.wikimedia.org/wikipedia/commons/f/fa/Microsoft_Azure.svg"} style={{ height: "30px", width: "30px", objectFit: "cover", marginRight: "10px", aspectRatio: "1/1" }} />
                                    <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 16 16" height="30px" width="30px" xmlns="http://www.w3.org/2000/svg"><path d="M8.5 2a5.001 5.001 0 0 1 4.905 4.027A3 3 0 0 1 13 12H3.5A3.5 3.5 0 0 1 .035 9H5.5a.5.5 0 0 0 0-1H.035a3.5 3.5 0 0 1 3.871-2.977A5.001 5.001 0 0 1 8.5 2zm-6 8a.5.5 0 0 0 0 1h9a.5.5 0 0 0 0-1h-9zM0 13.5a.5.5 0 0 1 .5-.5h9a.5.5 0 0 1 0 1h-9a.5.5 0 0 1-.5-.5z"></path></svg>
                                </div>
                            </Grid>
                        </Grid>
                        <CardContent>
                            ...
                            <Typography variant="body2" color="textSecondary">
                                Use AWS, GCP, Azure and Stand alone clusters to scale your apps
                            </Typography>
                        </CardContent>
                    </Card>
                    ...
                    <Card sx={{ mt: 2 }}>
                        <div style={{ paddingLeft: "10px", paddingTop: "10px" }}>
                            ...
                            <svg stroke="currentColor" fill="none" stroke-width="1" viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round" height="50px" width="50px" xmlns="http://www.w3.org/2000/svg"><path d="M3 4m0 3a3 3 0 0 1 3 -3h12a3 3 0 0 1 3 3v2a3 3 0 0 1 -3 3h-12a3 3 0 0 1 -3 -3z"></path><path d="M15 20h-9a3 3 0 0 1 -3 -3v-2a3 3 0 0 1 3 -3h12"></path><path d="M7 8v.01"></path><path d="M7 16v.01"></path><path d="M20 15l-2 3h3l-2 3"></path></svg>
                        </div>
                        <CardContent>
                            <Typography variant="h5" component="div" sx={{ fontSize: "1rem" }}>
