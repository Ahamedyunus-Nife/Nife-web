...
import oikosLogo from "../images/logo/Oikos.svg"
...
const SparkleAnimation = () => {
    ...
    const handleClick = () => {
        startTransition(() => {
            navigate('/oikos'); // Navigate to /oikos
    ...
    return (
        <>
            <Body>
                <Title>
                    Unlock <Circle>All Possibilities</Circle> with
                </Title>
                <Box>
                    <img
                        src={oikosLogo}
            ...
            <Center>
                ...
                >
                    EXPLORE MORE ABOUT OIKOS IN DETAIL
                </Button>
            </Center>
        </>
    );
